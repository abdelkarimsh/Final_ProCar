        ...
        var datatable = $('#kt_datatable').KTDatatable({
            ...
            },
            {
                ...
                template: function (data) {
                    return '\<a  href ="/Employee/Update/' + data.id + '" class="PopUp btn btn-sm btn-clean btn-icon mr-2" title="تعديل  بيانات ' + data.fullName + ' ">\
                        ...
                        <a href ="/Employee/Delete/' + data.id + '" tname="#kt_datatable" class="Confirm btn btn-sm btn-clean btn-icon" title="Delete">\
