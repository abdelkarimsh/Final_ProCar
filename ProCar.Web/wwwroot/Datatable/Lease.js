        ...
        var datatable = $('#kt_datatable').KTDatatable({
                ...
                },
            {
                ...
                template: function (data) {
                    var buttons = '';
                    buttons = buttons + '\<a  href ="/Lease/Update/' + data.id + '" class="PopUp btn btn-sm btn-clean btn-icon mr-2" title="تعديل  بيانات ' + data.title + ' ">\
                        ...
                        <a href ="/Lease/Delete/' + data.id + '" tname="#kt_datatable" class="Confirm btn btn-sm btn-clean btn-icon" title="Delete">\
                    ...
                    if (data.approval == 'Pending') {
                        buttons = buttons +
                            '<a href="/Lease/UpdateStatus/' + data.id + '&2" tname="#kt_datatable" class="Confirm btn btn-sm btn-clean btn-icon" title="موافقة" >\
...
<a href="/Lease/UpdateStatus/' + data.id + '&3" tname="#kt_datatable" class="Confirm btn btn-sm btn-clean btn-icon" title="رفض" >\
